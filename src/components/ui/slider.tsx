        ...
        handleRender={(node, handleProps) => {
          return (
            <div>
              ...
              {showHandleValue ? (
                <div
                  className='px-1 bg-primary-gray-200 text-primary-black dark:text-primary-white dark:bg-primary-gray-650 border dark:border-primary-gray-600 text-sm mb-4'
                  style={{
