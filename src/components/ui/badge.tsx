...
const badgeVariants = cva(
  'inline-flex items-center rounded-full border-2 px-2.5 py-0.5 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2',
  {
    variants: {
      variant: {
