...
const entries = {
  ...
  FeaturedCard: path.resolve(__dirname, 'src/components/ui/featured-card.tsx'),
  ...
  PageWideCard: path.resolve(__dirname, 'src/components/ui/card-page-wide.tsx'),
  ...
  ResourceCard: path.resolve(__dirname, 'src/components/ui/resource-card.tsx'),
  ...
  StatCard: path.resolve(__dirname, 'src/components/ui/stat-card.tsx'),
