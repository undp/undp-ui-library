...
const entries = {
  ...
  FeaturedCard: path.resolve(__dirname, 'src/components/ui/cards/featured-card.tsx'),
  FeatureShowcase: path.resolve(__dirname, 'src/components/ui/feature-showcase.tsx'),
  FileUpload: path.resolve(__dirname, 'src/components/ui/file-upload.tsx'),
  ...
  LanguageSwitcher: path.resolve(__dirname, 'src/components/ui/language-switcher/index.tsx'),
  ...
  Marker: path.resolve(__dirname, 'src/components/ui/marker.tsx'),
  ...
  PageHeader: path.resolve(__dirname, 'src/components/ui/page-header.tsx'),
  PageWideCard: path.resolve(__dirname, 'src/components/ui/cards/card-page-wide.tsx'),
  ...
  ResourceCard: path.resolve(__dirname, 'src/components/ui/cards/resource-card.tsx'),
  SDGBorder: path.resolve(__dirname, 'src/components/ui/sdg-border.tsx'),
  SDGCardButton: path.resolve(__dirname, 'src/components/ui/sdg-card-button.tsx'),
  SDGIcons: path.resolve(__dirname, 'src/components/ui/sdg-icons.tsx'),
  Search: path.resolve(__dirname, 'src/components/ui/input-search.tsx'),
  SegmentedControl: path.resolve(__dirname, 'src/components/ui/segmented-control.tsx'),
  ...
  StatCard: path.resolve(__dirname, 'src/components/ui/cards/stat-card.tsx'),
  StatsPanel: path.resolve(__dirname, 'src/components/ui/stats-panel.tsx'),
  ...
  VizCarousel: path.resolve(__dirname, 'src/components/ui/viz-carousel.tsx'),
